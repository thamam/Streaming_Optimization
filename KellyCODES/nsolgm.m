function [sol, it_hist, ierr,outstat] = nsolgm(x,f,tol, parms)
...
%
%Updates to support different eta selections
%
if numel(parms)<4
    parms(4)=1; %set the default as the original code
end
